...
- [hotShop 文档](#hotShop 文档)
    ...
    - [4. 业务架构](#4-业务架构)
    - [部署docker](#部署docker)
        - [1. Docker 安装及配置](#1-Docker-安装及配置)
            - [1.1 环境准备](#11-环境准备)
            - [1.2 安装 Docker](#12-安装-Docker)
            - [1.3 安装 Docker Compose](#13-安装-Docker-Compose)
            - [1.4 安装maven和JDK](#14-安装maven和JDK)
        - [2 构建和运行 Docker 服务](#2-构建和运行-Docker-服务)
            - [2.1 传输项目文件](#21-传输项目文件)
            - [2.2 快速启动](#22-快速启动)
            - [2.3 脚本启动](#23-脚本启动)
            - [2.4 自行启动](#24-自行启动)
        - [3 验证部署](#3-验证部署)
