-- Repeated MySQL -> redis-seckill activity loader v2.
-- Adds an atomically maintained Stream registry without changing the v1 script.
-- KEYS: 1 metadata hash, 2 stock string, 3 activity Stream, 4 staging metadata,
--       5 staging stock, 6 reservation Stream registry Set
